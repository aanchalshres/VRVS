...
class AvailabilityFirstStrategy implements RankingStrategyInterface
{
    public function getWeights(): array
    {
        return config('workflow.strategies.availability_first.weights', [
            'semantic' => 0.15, 'distance' => 0.10, 'skill' => 0.15,
            'availability' => 0.50, 'trust' => 0.10,
        ]);
    }
